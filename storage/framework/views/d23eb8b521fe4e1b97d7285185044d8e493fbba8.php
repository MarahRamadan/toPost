<?php foreach($attributes->onlyProps(['post'=> $post]) as $__key => $__value) {
    $$__key = $$__key ?? $__value;
} ?>
...
<div class="mb-4">
    <a href="<?php echo e(route('users.posts', $post->user)); ?>" class="font-bold"><?php echo e($post->user->name); ?></a> <span
    class="text-gray-600 text-sm"><?php echo e($post->created_at->diffForHumans()); ?> </span>
...
</div><?php /**PATH F:\toPost\resources\views/components/post.blade.php ENDPATH**/ ?>